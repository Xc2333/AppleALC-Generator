...
## cp
    cp -R  build/Release/AppleALC.kext ~/Desktop/AppleALC_CX20751_v$DebugLiluVer.kext

## done.  assuming no error  -_-||
    echo  "\033[1;32m AppleALC_CX20751_v$DebugLiluVer.kext has been built. \033[0m"
